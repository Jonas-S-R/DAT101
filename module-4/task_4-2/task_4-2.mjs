...
const part3Hei = "Hei på deg, hvordan har du det?";
const greetingArray = part3Hei.split(" ");
let part3Text = "";
...
const part4Names = ["Anne", "Inger", "Kari", "Marit", "Ingrid", "Liv", "Eva", "Berit", "Astrid", "Bjørg", "Hilde", "Anna", "Solveig", "Marianne", "Randi", "Ida", "Nina", "Maria", "Elisabeth", "Kristin"];
...
removeNameFromArray(part4Names, "Astrid");
printOut(part4Names);
...
const part5Names = ["Jakob", "Lucas", "Emil", "Oskar", "Oliver", "William", "Filip", "Noah", "Elias", "Isak", "Henrik", "Aksel", "Kasper", "Mathias", "Jonas", "Tobias", "Liam", "Håkon", "Theodor", "Magnus"];
...
printOut("Annbefaler disse ;)")
printOut(newLine)

const book1 = new TBook("Chainsaw Man, Vol. 1", "Tatsuki Fujimoto", "9781874709939");
const book2 = new TBook("The Horizon, Vol. 1", "Abigail Blackman, JH", "9798400900297");
const book3 = new TBook("Helvete", "Erlend Loe", "9788202639877");
